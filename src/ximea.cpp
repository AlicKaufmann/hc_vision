...
int startWebcamMonitoring(const Mat& cameraMatrix, const Mat& distanceCoefficients, float arucoSquareDimension, ros::Publisher* myPub)
{
	...
	// sample for XIMEA OpenCV                                                                                                                                   
        ...
        cam.OpenFirst();                                                                                                                                             
        //et exposure                                                                                                                                                
        cam.SetExposureTime(4000); //10000 us = 10 ms                                                                                                               
...
void cameraCalibrationProcess(Mat& cameraMatrix, Mat& distanceCoefficients)
{
	...
	{                                                                                                                                     
		...
		//cout << "blabla : " << found << "    " << count << endl;                                                                 
		if(found)                                                                                                              
		{                                                                                                                   
			count++;                                                                                                        
			imshow("Image with frame", drawToFrame);                                                                        
		}                                                                                                                                    
		else                                                                                                                               
		{                                                                                                                         
			imshow("Image with no frame", frame);                                                                                         
		}  
		...
		{                                                                                                                           
			case ' ':                                                                                                             
				...
				{                                                                                                                          
					...
					count_space++;                                                                                             
					cout << "count_space is :" << count_space << endl;                                          
				}                                                                                                                  
				break;                                                                                                           
				//case 27:                                                                                                                                                                                                                                                                  
				case 10 :                                                                                  
				...
				{                                                                                                                   
					cout << "I was in the saving condition" << endl;
